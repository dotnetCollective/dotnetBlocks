...
namespace dotNetBlocks.Extensions.DependencyInjection
{
    ...
    /// </summary>
    public static partial class ServiceCollectionServiceLazyExtensions
    {
        /// <summary>
            ...
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type implementationType)
        {
            ...
            return services.AddKeyedLazy(serviceType, serviceKey, implementationType, ServiceLifetime.Transient);
        }
            ...
            object? serviceKey)
        {
            ...
            return services.AddKeyedLazy(serviceType, serviceKey, implementationType:serviceType,ServiceLifetime.Transient);
        }
            ...
            where TImplementation : class, TService
        {
            ...
            //return services.AddKeyedSingletonLazy(typeof(TService), serviceKey, implementationFactory);
            var serviceDescriptor = LazyServiceDescriptorHelper.DescribeKeyedSingletonLazy<TService,TImplementation>(serviceKey, implementationFactory);
            ...
            where TService : class
        {
            ...
            return services.AddKeyedSingletonLazy<TService>(serviceKey, implementationInstance);
        }
